...
//                            mapdevice.put("type", user.areaList.get(i).type);
//                            mapdevice.put("controllerId", user.areaList.get(i).controllerId);
...
//            popupWindow.showAsDropDown(project_select, 0, dip2px(getActivity(), 10));
            popupWindow.showAtLocation(project_select, Gravity.NO_GRAVITY, xPos, location[1] + project_select.getHeight());
