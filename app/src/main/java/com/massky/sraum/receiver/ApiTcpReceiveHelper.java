...
public class ApiTcpReceiveHelper {
    ...
    public static String Sraum_PushDeviceName = api + "sraum_pushDeviceName";
    public static String Sraum_PushDeleteDevice = api + "sraum_pushDeleteDevice";
    public static String sraum_pushDeleteRoom = api + "sraum_pushDeleteRoom";
    public static String sraum_pushRoomName = api + "sraum_pushRoomName";
}
