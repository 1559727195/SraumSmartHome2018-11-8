...
import com.massky.sraumsmarthome.activity.WangGuanDetailItemActivity;
...
public class WangGuanListAdapter extends BaseAdapter {
    private List<Map> list = new ArrayList<>();

    public WangGuanListAdapter(Context context, List<Map> list) {
        super(context, list);
        this.list = list;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.wangguan_item, null);
            ...
            viewHolderContentType.swipeMenuLayout = (SwipeMenuLayout) convertView.findViewById(R.id.swipemenu_layout);
        ...
        viewHolderContentType.rel_scene_set.setOnClickListener(new View.OnClickListener() {//解决content SwipeMenulayout
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, WangGuanDetailItemActivity.class);
