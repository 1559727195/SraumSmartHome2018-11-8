...
import com.massky.sraumsmarthome.activity.SystemDetailMessageActivity;
...
public class SystemMessageAdapter extends BaseAdapter {
    ...
    public SystemMessageAdapter(Context context, List<Map> list) {
        super(context, list);
        this.list = list;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.system_message_item, null);
...
//        });
        convertView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                context.startActivity(new Intent(context, SystemDetailMessageActivity.class));
            }
        });
        return convertView;
    }
