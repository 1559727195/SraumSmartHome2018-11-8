...
import com.ipcamera.demo.adapter.PushVideoTimingNewAdapter;
...
public class MoveNotificationActivity extends BaseActivity implements OnClickListener,PushTimingInterface,CallBack_AlarmParamsInterface {
	...
	private PushVideoTimingNewAdapter pushAdapter = null; //adapter
	...
	public void findView(){
		...
		// 移动侦测推送
				...
				pushAdapter = new PushVideoTimingNewAdapter(MoveNotificationActivity.this, new PushVideoTimingNewAdapter.PushVideoTimingListener() {
					@Override
